...
function findWasmBinary() {
  return locateFile('pikafish.relaxed.wasm');
}
  ...
  var handleException = (e) => {
      ...
      if (e instanceof WebAssembly.RuntimeError) {
        if (_emscripten_stack_get_current() <= 0) {
          err('Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 3145728)');
        }
      }
      quit_(1, e);
    };

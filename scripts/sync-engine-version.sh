...
WASM="$ROOT/xqwlight/wasm/pikafish.wasm"
JS="$ROOT/xqwlight/wasm/pikafish.js"
RELAXED_WASM="$ROOT/xqwlight/wasm/pikafish.relaxed.wasm"
RELAXED_JS="$ROOT/xqwlight/wasm/pikafish.relaxed.js"
